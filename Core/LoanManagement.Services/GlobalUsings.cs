...
global using LoanManagement.Entities.RequestedLoans;
global using LoanManagement.Entities.RequestedLoans.Enums;
global using LoanManagement.Services.Customers.Contracts;
global using LoanManagement.Services.Customers.Contracts.Exceptions;
global using LoanManagement.Services.FinancialInformations.Contracts;
global using LoanManagement.Services.FinancialInformations.Exeptions;
...
global using LoanManagement.Services.Loans.Contracts.Exceptopns;
...
global using LoanManagement.Services.RequestedLoans.Contracts.DTOs;
global using LoanManagement.Services.RequestedLoans.Exceptions;
